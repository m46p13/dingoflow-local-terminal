...
export DINGOFLOW_PARAKEET_FINAL_PASS="${DINGOFLOW_PARAKEET_FINAL_PASS:-true}"
export DINGOFLOW_SPOKEN_FORMATTING_COMMANDS="${DINGOFLOW_SPOKEN_FORMATTING_COMMANDS:-true}"
export DINGOFLOW_SILENCE_GATE_DBFS="${DINGOFLOW_SILENCE_GATE_DBFS:--50}"
export DINGOFLOW_SPEECH_HANGOVER_MS="${DINGOFLOW_SPEECH_HANGOVER_MS:-480}"
export DINGOFLOW_SPEECH_ONSET_MS="${DINGOFLOW_SPEECH_ONSET_MS:-160}"
export DINGOFLOW_SPEECH_PREROLL_MS="${DINGOFLOW_SPEECH_PREROLL_MS:-180}"
export DINGOFLOW_SPEECH_NOISE_MARGIN_DB="${DINGOFLOW_SPEECH_NOISE_MARGIN_DB:-14}"
